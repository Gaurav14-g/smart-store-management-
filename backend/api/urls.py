...
from api.Product import view as ProductView
from api.Customer import view as CustomerView
from api.Bill import view as BillView
from api.Statistics import view as StatisticsView
...
router.register(r'product', ProductView.ProductViewset, basename='product'),
router.register(r'customer', CustomerView.CustomerViewset, basename='customer'),
router.register(r'bill', BillView.BillViewset, basename='bill'),
